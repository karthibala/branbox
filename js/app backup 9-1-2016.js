                                    ...
                                    if (updationGal=="gal") {   
                                        ...
                                        .success(function(data){
                                            ...
                                            db1.transaction(function(tx) {
                                                tx.executeSql('CREATE TABLE IF NOT EXISTS gallery (id INTEGER PRIMARY KEY AUTOINCREMENT, images TEXT, timeStamp TIMESTAMP)');
                                                tx.executeSql("SELECT * FROM  gallery", [], function(tx, results) {
                                                    ...
                                                    if(results.rows.length > 0)
                                                    {
                                                        ...
                                                        $.each(dataAjax, function(key, value) {
                                                            ...
                                                            //alert(found);
                                                            if(found < 0) {
                                                                filterArr.push({link: value.link,  createdTime: value.createdTime});
                                                            }
                                                        ...
                                                        $.each(filterArr, function(key, value) { 
                                                            ...
                                                            $cordovaFileTransfer.download(url, targetPath, options, trustHosts)
                                                                .then(function(result) {
                                                                    ...
                                                                    var db1 = window.openDatabase("branboxnew", "1.0", "branbox Demo", 100 * 1024 * 1024);
                                                                    db1.transaction(function(tx) { 
                                                                        tx.executeSql('INSERT OR REPLACE INTO gallery (images,timeStamp) VALUES("' +targetPath+ '","' +tstamp+ '")',successID,errID);
                                                                    });
                                                                    function successID(){
                                                        ...
                                                        $.each(dataAjax, function(key, value) {
                                                            ...
                                                            function success(dataArr){
                                                                ...
                                                                var db1 = window.openDatabase("branboxnew", "1.0", "branbox Demo", 100 * 1024 * 1024);
                                                                db1.transaction(function(tx) { 
                                                                    tx.executeSql('INSERT OR REPLACE INTO gallery (images,timeStamp) VALUES("' +path+ '","' +stamp+ '")',successID,errID);
                                                                });
                                                                function successID(){
